...
For the following feature, pick what might be
the best encoding for linear classification. The assumption is that
there are other features in the data set.

The point of this question is to think about alternatives; there are
many options, many not mentioned here.

Car make, e.g. Chevy, Ford, Toyota, VW, for predicting gas mileage (lo, hi).

--
An integer valued feature: 1, 2, 3, 4
